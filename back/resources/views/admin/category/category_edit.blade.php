                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name="category_name" class="form-control" value="{{ $result->category_name }}">
                                                @error('category_name')
                                        ...
                                        <div class="mb-3">
                                            <img id="showImage" src="{{ asset($result->category_image) }}" style="width:100px; height: 100px;">
                                        </div>
