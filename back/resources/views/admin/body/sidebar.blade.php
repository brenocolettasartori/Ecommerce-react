...
<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<h4 class="logo-text">E-commerce Shop</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{ url('/category/all') }}"><i class="bx bx-right-arrow-alt"></i>All categories</a>
						</li>
						<li> <a href="{{ url('/category/add') }}"><i class="bx bx-right-arrow-alt"></i>Add category</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{ url('/product/all')}}"><i class="bx bx-right-arrow-alt"></i>Products</a>
						</li>
						<li> <a href="{{ url('/product/add')}}"><i class="bx bx-right-arrow-alt"></i>Add product</a>
						</li>
