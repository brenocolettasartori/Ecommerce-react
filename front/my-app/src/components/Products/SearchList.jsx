...
class SearchList extends Component {
  render() {
    ...
    const seKey = this.props.seKey;
    const capitalizedSeKey = capitalizeFirstLetter(seKey);
    //console.log(seKey)
    ...
    return (
        ...
        <Breadcrumb>
          ...
          <Breadcrumb.Item> <StyledLink to={"/search/" + seKey}> {capitalizedSeKey} </StyledLink></Breadcrumb.Item>   
        </Breadcrumb>
        </div>
